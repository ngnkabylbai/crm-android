...
public final class HorizontalCalendar {
    ...
    private int textColorNormal, textColorSelected, monthColor;
    ...
    HorizontalCalendar(Builder builder) {
        ...
        this.monthColor = builder.monthColor;
...
//        return calendarView.getPositionOfCenterItem();
    ...
    public int getWeekdayColor() { return monthColor; }

    public void setWeekdayColor(int monthColor) { this.monthColor = monthColor; }
    ...
    public static class Builder {
        ...
        String formatMonth;
        int textColorNormal, textColorSelected, monthColor;
        ...
        public Builder textColor(int textColorNormal, int textColorSelected, int monthColor) {
            this.textColorNormal = textColorNormal;
            this.textColorSelected = textColorSelected;
