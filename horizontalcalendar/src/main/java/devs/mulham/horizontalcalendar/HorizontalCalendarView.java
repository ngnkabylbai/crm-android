...
public class HorizontalCalendarView extends RecyclerView {
    ...
    private int textColorNormal, textColorSelected, weekdayColor;
    ...
    public HorizontalCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            weekdayColor = a.getColor(R.styleable.HorizontalCalendarView_textWeekdayColor, Color.LTGRAY);
    ...
    public void setHorizontalCalendar(HorizontalCalendar horizontalCalendar) {
        ...
        if(horizontalCalendar.getWeekdayColor() == 0) {
            horizontalCalendar.setWeekdayColor(weekdayColor);
        }
